...
export default function NavBar() {
  return (
    <div className='bg-[#1015aeea] h-[120px] '>
      ...
      <a className='font-black text-[34px] uppercase text-white text-h-[15px] leading-13 tracking-[1px]' href="">Village Voice</a>
      </div>
        {/* <div className='flex item-center mb-[1rem] w-100% '>
      <img className=' m-0 w-[50px] mr-[1.5rem] bg-[#E5E7EB]' src={logImg} alt="" />
      <h1 className='font-[2.25rem] font-bold text-white leading-1 uppercase '>VILLAGE VOICE</h1>
      </div> */}
